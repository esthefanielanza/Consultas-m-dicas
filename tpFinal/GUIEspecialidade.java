...
public class GUIEspecialidade extends javax.swing.JDialog {
    ...
    private void botaoPesquisarHorariosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoPesquisarHorariosActionPerformed
    	GUIHorarios dialog = new GUIHorarios(new javax.swing.JFrame(), true, listaMedicos.encontraMedico(boxMedico.getSelectedItem().toString()), nomeCliente, boxEspecialidade.getSelectedItem().toString(), boxMedico.getSelectedItem().toString());
